			...
			<div class="card card-shadow">
				<div class="card-body">
					...
					<?php if (isset($_REQUEST['pass']) && $_REQUEST['pass']=="true"): ?>
						<nav class="alert alert-success">Password reset has been succesful and a temporary code has been sent to your registered phone number. Go to login now and change your temporary password immediately</nav>
						<?php else: ?>

      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar_global">
          ...
          <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="/fb" target="_blank" data-toggle="tooltip" title="Like us on Facebook">
            ...
            <div class="row">
              <div class="col-lg-7" >
                <h1 class="display-3  text-white">Presshub
                  <span>The Official Website Publication for CCS - The Browser</span>
                </h1>
                <p class="lead  text-white" >Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
